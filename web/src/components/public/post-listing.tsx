        ...
        {tagFilters.map((tag) => {
          ...
          return (
            <button
              ...
              className={`inline-flex h-8 w-full min-w-0 items-center justify-center rounded-full px-2 text-[11px] font-[500] whitespace-nowrap transition-colors sm:h-[34px] sm:w-auto sm:px-3 sm:text-xs ${
                isActive
            ...
            return (
              ...
              >
                <div className="relative h-44 w-full bg-neutral-200">
                  ...
                  <span
                    className={`absolute left-3 top-3 rounded-full px-2.5 py-1 font-mono text-[10px] font-medium text-white ${
                      badge === OTHER_TAG_LABEL ? "bg-neutral-600" : "bg-primary"
                    }`}
                  >
                    {badge}
                  </span>
